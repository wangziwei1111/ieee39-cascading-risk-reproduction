...
cfg.wind_trip_low_frequency_forced_hz = 46.5;
cfg.wind_trip_low_frequency_start_hz = 48.5;
cfg.wind_trip_high_frequency_start_hz = 50.5;
cfg.wind_trip_high_frequency_forced_hz = 51.5;
...
cfg.paper_line_P_in_r = NaN;            % 继电保护拒动概率，待校准
cfg.paper_line_P_in_c = NaN;            % 断路器拒动概率，待校准
cfg.paper_line_P_mis_c = NaN;           % 断路器误动概率，待校准
...
cfg.calibration_distance_hidden_failure_mode = 'disable_if_missing'; % disable_if_missing / proxy_by_line_loading
