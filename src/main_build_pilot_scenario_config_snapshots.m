...
for i = 1:numel(scenario_ids)
    ...
    if isempty(s)
        rows(end + 1, :) = {scenario_id, 'missing_in_scenario_library', ...
            ...
            NaN, NaN, '', '', cfg.scenario_penetration_definition, '', '', ...
    ...
    rows(end + 1, :) = {scenario_id, 'built_from_scenario_library_no_powerflow', ...
        ...
        s.wind_speed_mps, concentrated_bus, distributed_buses, ...
        cfg.scenario_penetration_definition, allocation, replaced, kept, ...
...
T = cell2table(rows, 'VariableNames', {'scenario_id', 'snapshot_status', ...
    ...
    'wind_capacity_per_bus_mw', 'wind_penetration', 'wind_speed_mps', ...
    'concentrated_bus', 'distributed_buses', 'penetration_definition', ...
    'capacity_allocation_rule', 'replaced_generator_buses', ...
    'kept_traditional_generator_buses', 'note'});
