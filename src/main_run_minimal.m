...
for i = 1:height(faults)
    ...
    if island_info.island_count > 1
        fprintf(island_log_fid, ['branch=%d (%d-%d), island_count=%d, main_island=%d, ', ...
            ...
            'main_load_share=%.6f, original_slack_load_share=%.6f, reason=%s\n'], ...
            ...
            island_info.main_island_selection_reason);
    end
    ...
    rows{i} = table( ...
        ...
        island_info.new_slack_bus, island_info.main_island_load_share, ...
        island_info.original_slack_island_load_share, string(island_info.main_island_selection_reason), ...
        pf_converged_before_shedding, pf_converged_after_shedding, ...
        ...
        'new_slack_bus', 'main_island_load_share', 'original_slack_island_load_share', ...
        'main_island_selection_reason', ...
        'pf_converged_before_shedding', 'pf_converged_after_shedding', ...
    ...
    island_rows{i} = table( ...
        ...
        island_info.main_island_load_mw, island_info.main_island_load_share, ...
        ...
        'main_island_load_mw', 'main_island_load_share', ...
        'main_island_generation_mw', 'main_island_gen_share', ...
        'original_slack_island_id', 'original_slack_island_load_mw', ...
        'original_slack_island_load_share', 'original_slack_island_generation_mw', ...
        'main_island_selection_reason'});
end
...
summary = table( ...
    ...
    NaN, max(result_table.main_island_load_share), min(result_table.original_slack_island_load_share), ...
    string("summary"), ...
    all(result_table.pf_converged_before_shedding), all(result_table.pf_converged_after_shedding), ...
