...
for sid = scenario_ids
    ...
    expected = paper_curve(scenario.wind_speed_mps, scenario.total_wind_capacity_mw);
    ...
    rows = [rows; table(sid, scenario.wind_speed_mps, scenario.total_wind_capacity_mw, expected, ...
        ...
        'expected_wind_power_total_mw','actual_wind_pg_total_mw_in_case','wind_bus_list', ...
